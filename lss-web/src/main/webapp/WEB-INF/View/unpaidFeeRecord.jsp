					...
					<div class="row">
						<div class="col-md-12">
							<blockquote class="blockquote-blue">
								<p>
									<strong>Unpaid Fee Information</strong>
								</p>
								<p>To get all unpaid fee record between two dates, select from
					...
					<form action="getpaidfeerecord"
						...
						<div class="row">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="button" id="unPaidFeeRecordBtn" class="btn btn-success" data-toggle="tooltip"
					...
					<div class="row">
						<div class="panel-body">
							<div class="col-md-12">
								...
								<div class="tab-content" id="unPaidFeeRecDiv">
									<br>
									<table class="table table-hover" id="unPaidFeeRecTable">
										<thead align="center">
											<tr>
...
<script type="text/javascript">
	 ...
	 $('#unPaidFeeRecordBtn').click(function(){
		 ...
		 if(fromDate!="" && toDate!=""){
			 $.ajax({
			      type: "POST",
			      url: "${pageContext.request.contextPath}/template/getunpaidfeerecord/",
			      data: {
			    	  fromDate: fromDate,
			    	  toDate: toDate
			      },
			      success: function(res) {
			    	 $("#unPaidFeeRecDiv").html(res);
			      },
			      error: function() {
